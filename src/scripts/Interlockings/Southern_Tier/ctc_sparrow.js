 ...
 * @brief CTC Controller Class for the CP Sparrow Interlocking
 */
...
/**
 * CLASS CTC_Sparrow
 * @brief Class is the Backend for the CP Sparrow Interlocking
 * 
 * @details This class is what controlls the CP Sparrow Interlocking, it is sort of like a backen, but is
...
class CTC_Sparrow {
    /**
     * constructor()
     * @brief The constructor for the CTC_Sparrow class
     * 
