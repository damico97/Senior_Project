 ...
 * @brief CTC Controller Class for the CP Central Valley Interlocking
 */
...
/**
 * CLASS CTC_Valley
 * @brief Class is the Backend for the CP Central Valley Interlocking
 * 
 * @details This class is what controlls the CP Central Valley Interlocking, it is sort of like a backen, but is
...
class CTC_Valley {
    /**
     * constructor()
     * @brief The constructor for the CTC_Valley class
     * 
    ...
    /**
     * get_occupied()
     * @brief Getter for the int_occupied 
     */
    get_occupied() {
