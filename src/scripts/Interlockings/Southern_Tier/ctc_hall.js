 ...
 * @brief CTC Controller Class for the CP Hall Interlocking
 */
...
/**
 * CLASS CTC_Hall
 * @brief Class is the Backend for the CP Hall Interlocking
 * 
 * @details This class is what controlls the CP Hall Interlocking, it is sort of like a backen, but is
...
class CTC_Hall {
    /**
     * constructor()
     * @brief The constructor for the CTC_Hall class
     * 
