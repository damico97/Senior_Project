 ...
 * @brief CTC Controller Class for the CP Harriman Interlocking
 */
...
/**
 * CLASS CTC_Harriman
 * @brief Class is the Backend for the CP Harriman Interlocking
 * 
 * @details This class is what controlls the CP Harriman Interlocking, it is sort of like a backen, but is
 ...
 * 
 * MEMBER VARIABLES
 * sw_21 -> Bool if Switch #21 is Reveresed or Not
 * sw_32 -> Bool if Switch #32 is Reveresed or Not
 * 
 * sig_1w -> Bool if Signal #1w is Lined or Not
 * sig_1e -> Bool if Signal #1e is Lined or Not
 * sig_2e -> Bool if Signal #2e is Lined or Not
 * sig_3e -> Bool if Signal #3e is Lined or Not
 * 
...
class CTC_Harriman {
    /**
     * constructor()
     * @brief The constructor for the CTC_Harriman class
     * 
