 ...
 * @brief CTC Controller Class for the CP PA Interlocking
 */
...
/**
 * CLASS CTC_PA
 * @brief Class is the Backend for the CP PA Interlocking
 * 
 * @details This class is what controlls the CP PA Interlocking, it is sort of like a backen, but is
...
class CTC_PA {
    /**
     * constructor()
     * @brief The constructor for the CTC_PA class
     * 
