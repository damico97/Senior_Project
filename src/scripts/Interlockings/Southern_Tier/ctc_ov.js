 ...
 * @brief CTC Controller Class for the CP OV Interlocking
 */
...
/**
 * CLASS CTC_OV
 * @brief Class is the Backend for the CP OV Interlocking
 * 
 * @details This class is what controlls the CP OV Interlocking, it is sort of like a backen, but is
 ...
 * sig_2ws -> Bool if Signal #2ws is Lined or Not
 * sig_2e -> Bool if Signal #2e is Lined or Not
 * 
 * route_w_trk_1 = The west bound route for track #1
 * route_w_trk_2 = The east bound route for track #2
...
class CTC_OV {
    /**
     * constructor()
     * @brief The constructor for the CTC_OV class
     * 
