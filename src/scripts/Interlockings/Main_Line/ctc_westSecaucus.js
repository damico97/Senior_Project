 ...
 * @brief CTC Controller Class for the West Secacus Interlocking
 */
 ...
 * @brief Class is the Backend for the West Secacus Interlocking
 * 
 * @details This class is what controlls the West Secacus Interlocking, it is sort of like a backen, but is
...
class CTC_WestSecaucus {
    /**
     * constructor()
     * @brief The constructor for the CTC_WestSecaucus class
     * 
