    ...
    render() { 
        return (  
            <div>
                ...
                <div class="laurel_sig_10w"><img src={SIG_W}/></div>
                <div class="laurel_sig_2w"><img src={SIG_W}/></div>
                <div class="laurel_sig_4w"><img src={SIG_W}/></div>
                <div class="laurel_sig_8w"><img src={SIG_W}/></div>

                <div class="laurel_sig_4e"><img src={SIG_E}/></div>
                <div class="laurel_sig_6e"><img src={SIG_E}/></div>
                <div class="laurel_sig_8e"><img src={SIG_E}/></div>
                <div class="laurel_sig_12e"><img src={SIG_E}/></div>
            </div>
        );
    }
}
