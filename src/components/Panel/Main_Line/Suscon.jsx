    ...
    set_route_drawing = () => {
        ...
        if (this.state.route_trk_1 && this.state.route_trk_2) {
            ...
            if (!this.state.occupied_trk_1 && !this.state.occupied_trk_2) {
                ...
                // Setting Signals
                // Track 1 West Bound
                if (this.state.route_trk_1 === "W_1_1__|__1_ridgewood_suscon") {
                ...
                // Track 2 West Bound
                if (this.state.route_trk_2 === "W_2_2__|__2_ridgewood_suscon") {
        ...
        // Track 1 Is Empty And Track 2 Is Lined
            ...
            if (this.state.occupied_trk_2) {
                ...
                if (this.state.route_trk_2 === "E_2_1__|__1_suscon_mill") {
                    // Setting Tail Tracks
                    this.state.tail_1_e = Occupied;
                    this.state.tail_2_w = Occupied;
                ...
                else if (this.state.route_trk_2 === "W_2_1__|__1_ridgewood_suscon") {
                    // Setting Tail Tracks
                    this.state.tail_1_w = Occupied;
                    this.state.tail_2_e = Occupied;
            ...
            else if (this.state.route_trk_2 === "W_2_2__|__2_ridgewood_suscon") {
                // Setting Tail Tracks
                this.state.tail_2_e = Route;
                this.state.tail_2_w = Route;
            ...
            else if (this.state.route_trk_2 === "E_2_2__|__2_suscon_mill") {
                // Setting Tail Tracks
                this.state.tail_2_e = Route;
                this.state.tail_2_w = Route;
            ...
            else if (this.state.route_trk_2 === "E_2_1__|__1_suscon_mill") {
                // Setting Tail Tracks
                this.state.tail_1_e = Route;
                this.state.tail_2_w = Route;
        ...
        // Also covers any crossover moves
            ...
            if (this.state.occupied_trk_1) {
                // Crossover Using SW_1
                if (this.state.route_trk_1 === "W_1_2__|__2_ridgewood_suscon") {
                    // Setting Tail Tracks
                    this.state.tail_1_e = Occupied;
                    this.state.tail_2_w = Occupied;
                ...
                // Crossover Using SW_3
                else if (this.state.route_trk_1 === "E_1_2__|__2_suscon_mill") {
                    // Setting Tail Tracks
                    this.state.tail_1_w = Occupied;
                    this.state.tail_2_e = Occupied;
            ...
            else if (this.state.route_trk_1 === "W_1_1__|__1_ridgewood_suscon") {
                // Setting Tail Tracks
                this.state.tail_1_e = Route;
                this.state.tail_1_w = Route;
            ...
            else if (this.state.route_trk_1 === "E_1_1__|__1_suscon_mill") {
                // Setting Tail Tracks
                this.state.tail_1_e = Route;
                this.state.tail_1_w = Route;
            ...
            // Crossover Using SW_1
            else if (this.state.route_trk_1 === "W_1_2__|__2_ridgewood_suscon") {
                // Setting Tail Tracks
                this.state.tail_1_e = Route;
                this.state.tail_2_w = Route;
