    ...
    render() { 
        ...
        return ( 
            <div>
                ...
                <div className="bt_sig_2w-2" onClick={this.props.click_sig_2w2}><img src={SIG_W}/></div>
                <div className="bt_sig_2w-1" onClick={this.props.click_sig_2w1}><img src={SIG_W}/></div>
                <div className="bt_sig_4w" onClick={this.props.click_sig_4w}><img src={SIG_W}/></div>

                <div className="bt_sig_2e" onClick={this.props.click_sig_2e}><img src={SIG_E}/></div>
                <div className="bt_sig_4e" onClick={this.props.click_sig_4e}><img src={SIG_E}/></div>
            </div>
        );
    }
