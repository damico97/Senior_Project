    ...
    render() { 
        ...
        return (  
            <div>
                ...
                <div className="valley_sig_2w" onClick={this.props.click_sig_2w}><img src={SIG_W}/></div>
                <div className="valley_sig_1w" onClick={this.props.click_sig_1w}><img src={SIG_W}/></div>

                <div className="valley_sig_1e" onClick={this.props.click_sig_1e}><img src={SIG_E}/></div>
            </div>
        );
    }
